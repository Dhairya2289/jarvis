...
from jarvis_v3.workflows.schema import Workflow, Node, Connection
from jarvis_v3.workflows.loader import load_workflow
from jarvis_v3.workflows.engine import WorkflowEngine
...
def test_load_morning_brief(tmp_path: Path):
    src = Path(__file__).parent.parent / "examples" / "workflows" / "morning_brief.yaml"
    if not src.exists():
...
def test_cli_workflow_imports():
    from jarvis_v3.cli_workflows import workflow_cli
