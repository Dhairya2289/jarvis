...
async def interactive_loop():
    ...
    while True:
        try:
            ...
            if raw.lower() == "/stats":
                try:
                    from jarvis_v3.orchestrator import get_routing_report
...
def doctor():
    ...
    from jarvis_v3.api_manager import get_manager
...
def main():
    ...
    if args.hud:
        try:
            from jarvis_v3.gui_server import run_server
            run_server()
        except Exception as e:
            print(f"HUD error: {e}")
        return
    ...
    if args.vision:
        try:
            from jarvis_v3.vision_tool import capture_and_ask
