"""
Tests for jarvis.screen_region and jarvis.vision_tool
"""
...
from jarvis.screen_region import image_to_base64, base64_to_image
...
class TestVisionTool:
    @patch("jarvis.vision_tool.get_manager")
    @patch("jarvis.vision_tool.image_to_base64")
    def test_ask_about_image(self, mock_b64, mock_get_mgr):
        import asyncio
        from jarvis.vision_tool import ask_about_image
